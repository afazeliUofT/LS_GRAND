# LS-GRAND decisive pivot gate report

## Automated classification

**CONTINUE_APPROXIMATE_LATENT_SEARCH_CANDIDATE**

The low-description latent search is promising, but the exact marginal/certificate story is not yet practically justified.
...
- **F0_EXACTNESS**: PASS
- **F1_MARGINAL_FIBER_RELEVANCE**: FAIL
- **F2_EMPIRICAL_RANK_COMPRESSION**: PASS
- **F3_APPROXIMATE_CANDIDATE_FRONTIER**: PASS
- **F4_EXACT_CERTIFICATE_USEFULNESS**: FAIL
- **F5_TARGET_ORBIT_IDENTIFIABILITY**: PASS
- **F6_REPRODUCIBILITY**: PASS

## Exact mathematical core

- Non-tied exhaustive-oracle trials: 1200
- Certified mismatches: 0
- Certificate failures/caps: 0
- Marginal-versus-first decision switches: 189
- Marginal / first errors: 625 / 634
- Median effective winner-path multiplicity: 1.0623003058608091
